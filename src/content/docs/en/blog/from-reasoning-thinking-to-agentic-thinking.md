...
date: 2026-03-26
description: The future is a shift from training models to training agents, and from training agents to training systems.
authors:
    - name: Junyang Lin
...
Original: [From "Reasoning" Thinking to "Agentic" Thinking](https://justinlin610.github.io/blog/from-reasoning-to-agentic-thinking/)